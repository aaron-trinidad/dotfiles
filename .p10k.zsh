# Generated by Powerlevel10k configuration wizard on 2025-06-09 at 15:55 CST.
...
() {
  ...
  # avalon Theme
  # typeset -g COLOR_BACKGROUND="#3e3e3e"    # bl: dark background
  # typeset -g COLOR_FOREGROUND="#f0ead6"    # na: main text

  # --- ANSI colors ---
  # typeset -g COLOR_BLACK="#1c1c1c"         # bl: dark background
  # typeset -g COLOR_RED="#a5bcc7"           # ia: intense red
  # typeset -g COLOR_GREEN="#82a37f"         # va: soft green
  # typeset -g COLOR_YELLOW="#e0d8c7"        # ca: beige
  # typeset -g COLOR_BLUE="#95becf"          # va: light blue
  # typeset -g COLOR_MAGENTA="#dbb2d1"       # ca: lavender
  # typeset -g COLOR_CYAN="#d6dfe4"          # va: teal
  # typeset -g COLOR_WHITE="#f0ead6"         # na: light gray

  # --- Bright ANSI colors ---
  # typeset -g COLOR_BRIGHT_BLACK="#727169"  # nb: medium gray
  # typeset -g COLOR_BRIGHT_RED="#b5ccd8"    # ia: bright red
  # typeset -g COLOR_BRIGHT_GREEN="#9cbd91"  # va: bright green
  # typeset -g COLOR_BRIGHT_YELLOW="#efe3d3" # ca: bright beige
  # typeset -g COLOR_BRIGHT_BLUE="#a6d6e0"   # va: bright blue
  # typeset -g COLOR_BRIGHT_MAGENTA="#e6c4de" # ca: bright lavender
  # typeset -g COLOR_BRIGHT_CYAN="#e8eef2"   # va: bright teal
  # typeset -g COLOR_BRIGHT_WHITE="#ffffff"  # na: bright white
